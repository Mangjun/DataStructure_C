...
int main() {
	...
	insertLast(list1, 3, 6);
	insertLast(list1, 7, 3);
	insertLast(list1, -2, 2);
	insertLast(list1, -9, 0);

	insertLast(list2, -2, 6);
	insertLast(list2, -4, 4);
	insertLast(list2, 6, 2);
	insertLast(list2, 6, 1);
	insertLast(list2, 1, 0);
